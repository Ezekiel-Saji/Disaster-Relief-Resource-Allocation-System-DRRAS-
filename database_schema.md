...
### Constraints
- **Primary Key:** area_id  
- **Foreign Key:** disaster_id → DISASTER(disaster_id)
...
### Constraints
- **Primary Key:** id  
- **Foreign Key:** area_id → AFFECTED_AREA(area_id)

### Relationship
- **AFFECTED_AREA (1) → (N) DISASTER_HISTORY**
...
### Relationship
- **AFFECTED_AREA (1) → (N) WEATHER_DATA**
...
### Relationship
- **AFFECTED_AREA (1) → (N) RISK_PREDICTION**
...
- **Foreign Keys:**  
  - area_id → AFFECTED_AREA(area_id)  
  - resource_id → RESOURCE_TYPE(resource_id)

### Relationships
- **AFFECTED_AREA (1) → (N) AREA_REQUEST**  
- **RESOURCE_TYPE (1) → (N) AREA_REQUEST**
...
### Relationships
- **RELIEF_CENTER (1) → (N) INVENTORY**  
- **RESOURCE_TYPE (1) → (N) INVENTORY**
...
- **Foreign Keys:**  
  - request_id → AREA_REQUEST(request_id)  
  - center_id → RELIEF_CENTER(center_id)

### Relationships
- **AREA_REQUEST (1) → (N) ALLOCATION**  
- **RELIEF_CENTER (1) → (N) ALLOCATION**
